...
list($entry) = mysql_fetch_row($rs_duplicate);
...
$sql_insert = "INSERT into users
  			(full_name,user_email,pwd,tel,date,users_ip,activation_code,user_name
			)
		    VALUES
		    ('$data[full_name]','$usr_email','$sha1pass','$data[tel]',now(),'$user_ip','$activ_code','$user_name'
			)
			";
...
<p>
	...
	?></p>
      ...
      <p>Please note that fields marked <span class="required">*</span> 
        are required.</p>
	  <?php	
	 if(!empty($err))  {
	   echo "<div class=\"msg\">";
