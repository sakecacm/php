...
<div class="row">
<div class="col-lg-6">
<span class="logo">STTP on "Web Tchnology"</span></div>
<?php
...
<li class="dropdown"   <?php  echo 'class="active"'; ?>>
<a href="#" class="dropdown-toggle" data-toggle="dropdown">Quize <b class="caret"></b></a> 
<ul class="dropdown-menu">
							<li><a href="quiz.php?q=4">Add Quize</a></li>
                            <li><a href="quiz.php?q=5">Remove Quize</a></li>
                            <li><a href="quiz.php?q=2">Leaderboard</a></li>
</ul>	
</li>
...
<ul class="dropdown-menu">
							<li><a href="feedback.php?q=1">Add Feedback</a></li>
                            <li><a href="feedback.php?q=2">Remove Feedback</a></li>
                            <li><a href="feedback.php?q=3">Add Session</a></li>
							<li><a href="feedback.php?q=4">Remove Session</a></li>
